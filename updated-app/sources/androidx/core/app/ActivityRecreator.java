...
final class ActivityRecreator {
    ...
    private static Method getRequestRelaunchActivityMethod(Class<?> activityThreadClass2) {
        ...
        try {
            ...
            Class<Configuration> cls3 = Configuration.class;
            Method relaunch = activityThreadClass2.getDeclaredMethod("requestRelaunchActivity", new Class[]{IBinder.class, cls, cls, Integer.TYPE, cls2, cls3, cls3, cls2, cls2});
