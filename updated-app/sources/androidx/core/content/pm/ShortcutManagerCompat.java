...
public class ShortcutManagerCompat {
    ...
    public static boolean pushDynamicShortcut(android.content.Context r7, androidx.core.content.pm.ShortcutInfoCompat r8) {
        ...
        L_0x0095:
            ...
            java.util.List r4 = r3.getShortcuts()     // Catch:{ Exception -> 0x0108, all -> 0x00e3 }
            int r5 = r4.size()     // Catch:{ Exception -> 0x0108, all -> 0x00e3 }
            if (r5 < r0) goto L_0x00b3
            java.lang.String r5 = getShortcutInfoCompatWithLowestRank(r4)     // Catch:{ Exception -> 0x0108, all -> 0x00e3 }
            java.lang.String[] r6 = new java.lang.String[r2]     // Catch:{ Exception -> 0x0108, all -> 0x00e3 }
            r6[r1] = r5     // Catch:{ Exception -> 0x0108, all -> 0x00e3 }
            java.util.List r5 = java.util.Arrays.asList(r6)     // Catch:{ Exception -> 0x0108, all -> 0x00e3 }
            r3.removeShortcuts(r5)     // Catch:{ Exception -> 0x0108, all -> 0x00e3 }
        L_0x00b3:
            androidx.core.content.pm.ShortcutInfoCompat[] r5 = new androidx.core.content.pm.ShortcutInfoCompat[r2]     // Catch:{ Exception -> 0x0108, all -> 0x00e3 }
            r5[r1] = r8     // Catch:{ Exception -> 0x0108, all -> 0x00e3 }
            java.util.List r5 = java.util.Arrays.asList(r5)     // Catch:{ Exception -> 0x0108, all -> 0x00e3 }
            r3.addShortcuts(r5)     // Catch:{ Exception -> 0x0108, all -> 0x00e3 }
