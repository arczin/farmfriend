...
public final class ColorUtils {
    ...
    static class Api26Impl {
        ...
        static Color compositeColors(Color foreground, Color background) {
            Color s;
            if (ColorUtils$Api26Impl$$ExternalSyntheticBackport0.m(foreground.getModel(), background.getModel())) {
                if (ColorUtils$Api26Impl$$ExternalSyntheticBackport0.m(background.getColorSpace(), foreground.getColorSpace())) {
                    s = foreground;
                } else {
