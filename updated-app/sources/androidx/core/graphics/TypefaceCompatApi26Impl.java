...
import androidx.core.content.pm.ShortcutXmlParser$$ExternalSyntheticBackport0;
...
public class TypefaceCompatApi26Impl extends TypefaceCompatApi21Impl {
    ...
    public Typeface createFromFontInfo(Context context, CancellationSignal cancellationSignal, FontsContractCompat.FontInfo[] fonts, int style) {
        ...
        if (!isFontFamilyPrivateAPIAvailable()) {
            ...
            try {
                ...
                ShortcutXmlParser$$ExternalSyntheticBackport0.m(th, th2);
            }
        } else {
    ...
    public Method obtainAddFontFromAssetManagerMethod(Class<?> fontFamily) throws NoSuchMethodException {
        ...
        return fontFamily.getMethod(ADD_FONT_FROM_ASSET_MANAGER_METHOD, new Class[]{AssetManager.class, String.class, cls, Boolean.TYPE, cls, cls, cls, FontVariationAxis[].class});
    }

    /* access modifiers changed from: protected */
    public Method obtainAddFontFromBufferMethod(Class<?> fontFamily) throws NoSuchMethodException {
        Class cls = Integer.TYPE;
        return fontFamily.getMethod(ADD_FONT_FROM_BUFFER_METHOD, new Class[]{ByteBuffer.class, cls, FontVariationAxis[].class, cls, cls});
    }
    ...
    public Method obtainCreateFromFamiliesWithDefaultMethod(Class<?> fontFamily) throws NoSuchMethodException {
        Class cls = Integer.TYPE;
        Method m = Typeface.class.getDeclaredMethod(CREATE_FROM_FAMILIES_WITH_DEFAULT_METHOD, new Class[]{Array.newInstance(fontFamily, 1).getClass(), cls, cls});
