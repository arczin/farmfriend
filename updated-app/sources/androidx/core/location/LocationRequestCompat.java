...
public final class LocationRequestCompat {
    ...
    public long getMinUpdateIntervalMillis() {
        if (this.mMinUpdateIntervalMillis == IMPLICIT_MIN_UPDATE_INTERVAL) {
            return this.mIntervalMillis;
        }
    ...
    public String toString() {
        ...
        if (this.mMinUpdateIntervalMillis != IMPLICIT_MIN_UPDATE_INTERVAL && this.mMinUpdateIntervalMillis < this.mIntervalMillis) {
    ...
    public static final class Builder {
        ...
        public Builder setMaxUpdates(int maxUpdates) {
            this.mMaxUpdates = Preconditions.checkArgumentInRange(maxUpdates, 1, (int) ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, "maxUpdates");
            return this;
        }
