...
public class AnimatorInflaterCompat {
    ...
    private static android.animation.PropertyValuesHolder getPVH(android.content.res.TypedArray r22, int r23, int r24, int r25, java.lang.String r26) {
        ...
        L_0x018d:
            ...
            r4 = 0
            int r4 = r0.getColor(r11, r4)
            goto L_0x019e
        L_0x0199:
            r4 = 0
            int r4 = r0.getInt(r11, r4)
        L_0x019e:
            int[] r5 = new int[]{r6, r4}
            android.animation.PropertyValuesHolder r14 = android.animation.PropertyValuesHolder.ofInt(r3, r5)
            goto L_0x01d6
        L_0x01a7:
            int[] r4 = new int[]{r6}
            android.animation.PropertyValuesHolder r14 = android.animation.PropertyValuesHolder.ofInt(r3, r4)
            goto L_0x01d6
        L_0x01b0:
