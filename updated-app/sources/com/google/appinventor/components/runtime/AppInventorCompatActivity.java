...
public class AppInventorCompatActivity extends Activity implements AppCompatCallback {
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (Build.VERSION.SDK_INT >= 35) {
            ViewCompat.setOnApplyWindowInsetsListener(getWindow().getDecorView(), new AppInventorCompatActivity$$ExternalSyntheticLambda0());
        }
    ...
    static /* synthetic */ WindowInsetsCompat lambda$onCreate$0(View v, WindowInsetsCompat windowInsets) {
