...
public interface Component {
    ...
    public static final int CHART_VALUE_DATE = 2;
    public static final int CHART_VALUE_DECIMAL = 0;
    public static final int CHART_VALUE_INTEGER = 1;
    public static final int CHART_VALUE_TIME = 3;
