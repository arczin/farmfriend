...
public class EmailPicker extends TextBoxBase {
    ...
    public final EmailAddressAdapter addressAdapter;
        ...
        this.container.$form().askPermission("android.permission.READ_CONTACTS", new PermissionResultHandler() {
            public void HandlePermissionResponse(String permission, boolean granted) {
                if (granted) {
                    ...
                    EmailPicker.this.container.$form().dispatchPermissionDeniedEvent((Component) EmailPicker.this, "Initialize", permission);
                }
            }
        });
    }
