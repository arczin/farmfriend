...
public class Ev3Motors extends LegoMindstormsEv3Base {
    ...
    private void outputStepPower(String functionName, int layer, int nos, int power, int step1, int step2, int step3, boolean brake) {
        ...
        Object[] objArr = {Byte.valueOf((byte) i), Byte.valueOf((byte) i2), Byte.valueOf((byte) power2), Integer.valueOf(step1), Integer.valueOf(step2), Integer.valueOf(step3), Byte.valueOf(brake ? (byte) 1 : 0)};
    ...
    private void outputStepSpeed(String functionName, int layer, int nos, int speed, int step1, int step2, int step3, boolean brake) {
        ...
        Object[] objArr = {Byte.valueOf((byte) i), Byte.valueOf((byte) i2), Byte.valueOf((byte) speed2), Integer.valueOf(step1), Integer.valueOf(step2), Integer.valueOf(step3), Byte.valueOf(brake ? (byte) 1 : 0)};
    ...
    private void outputStepSync(String functionName, int layer, int nos, int speed, int turnRatio, int tachoCounts, boolean brake) {
        ...
        int speed2 = roundValue(speed, -100, 100);
        Object[] objArr = {Byte.valueOf((byte) i), Byte.valueOf((byte) i2), Byte.valueOf((byte) speed2), Short.valueOf((short) i3), Integer.valueOf(tachoCounts), Byte.valueOf(brake ? (byte) 1 : 0)};
    ...
    private void outputTimeSync(String functionName, int layer, int nos, int speed, int turnRatio, int milliseconds, boolean brake) {
        ...
        int speed2 = roundValue(speed, -100, 100);
        Object[] objArr = {Byte.valueOf((byte) i), Byte.valueOf((byte) i2), Byte.valueOf((byte) speed2), Short.valueOf((short) turnRatio), Integer.valueOf(milliseconds), Byte.valueOf(brake ? (byte) 1 : 0)};
    ...
    private void setOutputSpeed(String functionName, int layer, int nos, int speed) {
        ...
        int speed2 = roundValue(speed, -100, 100);
        sendCommand(functionName, Ev3BinaryParser.encodeDirectCommand(Ev3Constants.Opcode.OUTPUT_SPEED, false, 0, 0, "ccc", Byte.valueOf((byte) layer), Byte.valueOf((byte) nos), Byte.valueOf((byte) speed2)), false);
    }
    ...
    private void setOutputPower(String functionName, int layer, int nos, int power) {
        ...
        int power2 = roundValue(power, -100, 100);
        sendCommand(functionName, Ev3BinaryParser.encodeDirectCommand(Ev3Constants.Opcode.OUTPUT_POWER, false, 0, 0, "ccc", Byte.valueOf((byte) layer), Byte.valueOf((byte) nos), Byte.valueOf((byte) power2)), false);
    }
    ...
    public int getOutputCount(String functionName, int layer, int nos) {
        ...
        Object[] objArr = {Byte.valueOf((byte) i), Byte.valueOf((byte) portNumber), (byte) 0};
        byte[] reply = sendCommand(functionName, Ev3BinaryParser.encodeDirectCommand(Ev3Constants.Opcode.OUTPUT_GET_COUNT, true, 4, 0, "ccg", objArr), true);
