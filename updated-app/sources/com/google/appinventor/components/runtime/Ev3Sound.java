...
public class Ev3Sound extends LegoMindstormsEv3Base {
    ...
    public void PlayTone(int volume, int frequency, int milliseconds) {
        ...
        sendCommand(functionName, Ev3BinaryParser.encodeDirectCommand((byte) -108, true, 0, 0, "cccc", (byte) 1, Byte.valueOf((byte) i), Short.valueOf((short) i2), Short.valueOf((short) i3)), true);
    }
