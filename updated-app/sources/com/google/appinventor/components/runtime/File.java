...
public class File extends FileBase implements Component {
    ...
    public void MakeDirectory(FileScope scope, String directoryName, Continuation<Boolean> continuation) {
        ...
        new SingleFileOperation(this, this.form, this, "MakeDirectory", directoryName, scope, FileAccessMode.WRITE, false) {
    ...
    public void ListDirectory(FileScope scope, String directoryName, Continuation<List<String>> continuation) {
        if (scope == FileScope.Asset && !this.form.isRepl()) {
            ...
            DocumentFile[] files = DocumentFile.fromTreeUri(this.form, Uri.parse(directoryName)).listFiles();
            List<String> result2 = new ArrayList<>();
            for (DocumentFile file : files) {
                result2.add(file.getName());
            }
            continuation.call(result2);
        }
    }
    ...
    private void write(String filename, String method, String text, boolean append) {
        String str = filename;
        if (str.startsWith("//")) {
            this.form.dispatchErrorOccurredEvent(this, method, ErrorMessages.ERROR_CANNOT_WRITE_ASSET, str);
            return;
        }
        String str2 = method;
        if (str.startsWith("/")) {
        ...
        try {
            ...
            new FileStreamWriteOperation(this, this.form, this, method, filename, this.scope, append, true) {
                final /* synthetic */ File this$0;
                ...
                public void processFile(ScopedFile scopedFile) {
                    ...
                    if (!file.exists()) {
                        ...
                        if (!success) {
                            this.form.dispatchErrorOccurredEvent(this.this$0, this.method, ErrorMessages.ERROR_CANNOT_CREATE_FILE, file.getAbsolutePath());
                            return;
                        }
                    }
                ...
                public boolean process(OutputStreamWriter out) throws IOException {
                    ...
                    this.form.runOnUiThread(new Runnable() {
                        public void run() {
                            AnonymousClass9.this.this$0.AfterFileSaved(str4);
                        }
                    });
                    return true;
                }
                ...
                public void onError(IOException e) {
                    ...
                    this.form.dispatchErrorOccurredEvent(this.this$0, this.method, ErrorMessages.ERROR_CANNOT_WRITE_TO_FILE, fileName);
                }
            }.run();
        } catch (StopBlocksExecution e) {
        }
