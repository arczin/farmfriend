...
public class ImagePicker extends Picker implements ActivityResultListener {
    ...
    public void resultReturned(int requestCode, int resultCode, Intent data) {
        if (requestCode == this.requestCode && resultCode == -1) {
            ...
            String extension = "." + MimeTypeMap.getSingleton().getExtensionFromMimeType(this.container.$context().getContentResolver().getType(selectedImage));
