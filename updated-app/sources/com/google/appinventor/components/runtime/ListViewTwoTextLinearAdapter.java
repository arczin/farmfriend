...
public class ListViewTwoTextLinearAdapter extends ListAdapterWithRecyclerView {
    ...
    public ListViewTwoTextLinearAdapter(ComponentContainer container, List<Object> data, int textMainColor2, float textMainSize2, String textMainFont2, int textDetailColor2, float textDetailSize2, String textDetailFont2, int backgroundColor, int selectionColor, int radius, int imageWidth, int imageHeight) {
    ...
    public class TwoTextLinearRvViewHolder extends ListAdapterWithRecyclerView.RvViewHolder {
        ...
        public TwoTextLinearRvViewHolder(View view, int idCard, int idFirst, int idSecond) {
            super(view);
