...
public final class Notifier extends AndroidNonvisibleComponent implements Component {
    ...
    public void LogError(String message) {
        ...
        if (this.form.isRepl()) {
            RetValManager.appendLogValue(message, LOG_TAG, "OK", "Error");
        }
    }
    ...
    public void LogWarning(String message) {
        ...
        if (this.form.isRepl()) {
            RetValManager.appendLogValue(message, LOG_TAG, "OK", "Warning");
        }
    }
    ...
    public void LogInfo(String message) {
        ...
        if (this.form.isRepl()) {
            RetValManager.appendLogValue(message, LOG_TAG, "OK", "Info");
        }
    }
}
