...
public class NxtColorSensor extends LegoMindstormsNxtSensor implements Deleteable {
    ...
    private static final Map<Integer, NxtSensorType> mapColorToSensorType = new HashMap();
    ...
    static {
        mapColorToSensorType.put(-65536, NxtSensorType.ColorRed);
        Map<Integer, NxtSensorType> map = mapColorToSensorType;
        Integer valueOf = Integer.valueOf(Component.COLOR_GREEN);
        map.put(valueOf, NxtSensorType.ColorGreen);
        Map<Integer, NxtSensorType> map2 = mapColorToSensorType;
        Integer valueOf2 = Integer.valueOf(Component.COLOR_BLUE);
        map2.put(valueOf2, NxtSensorType.ColorBlue);
        mapColorToSensorType.put(16777215, NxtSensorType.ColorNone);
        mapSensorValueToColor.put(1, -16777216);
        mapSensorValueToColor.put(2, valueOf2);
        mapSensorValueToColor.put(3, valueOf);
