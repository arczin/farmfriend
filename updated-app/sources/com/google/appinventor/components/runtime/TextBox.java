...
public final class TextBox extends TextBoxBase {
    ...
    @DesignerProperty(defaultValue = "False", editorType = "boolean")
    @SimpleProperty
    public void MultiLine(boolean multiLine2) {
        this.multiLine = multiLine2;
        this.view.setSingleLine(!multiLine2);
    }

    @SimpleProperty(category = PropertyCategory.BEHAVIOR, description = "Whether the %type% is read-only. By default, this is false.")
    ...
    public void ReadOnly(boolean readOnly2) {
        ...
        this.view.setEnabled(!readOnly2);
    }
}
