...
public final class WebViewer extends AndroidViewComponent {
    ...
    @SimpleProperty
    public void IgnoreSslErrors(boolean ignoreSslErrors2) {
        this.ignoreSslErrors = ignoreSslErrors2;
        resetWebViewClient();
    }
    ...
    @SimpleProperty(category = PropertyCategory.BEHAVIOR, description = "Whether or not to give the application permission to use the camera. This property is available only in the designer.", userVisible = false)
    ...
    @DesignerProperty(defaultValue = "False", editorType = "boolean")
    @UsesPermissions({"android.permission.RECORD_AUDIO", "android.permission.MODIFY_AUDIO_SETTINGS"})
    @SimpleProperty(category = PropertyCategory.BEHAVIOR, description = "Whether or not to give the application permission to use the microphone. This property is available only in the designer.", userVisible = false)
    public void UsesMicrophone(boolean uses) {
        this.usesMicrophone = uses;
    }

    public boolean UsesMicrophone() {
        return this.usesMicrophone;
    }

    @DesignerProperty(defaultValue = "False", editorType = "boolean")
    @SimpleProperty(category = PropertyCategory.BEHAVIOR, description = "Whether or not to give the application permission to use the Javascript geolocation API. This property is available only in the designer.", userVisible = false)
    ...
    public void PromptforPermission(boolean prompt2) {
        this.prompt = prompt2;
    }
