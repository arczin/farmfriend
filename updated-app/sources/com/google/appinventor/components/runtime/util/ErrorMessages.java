...
public final class ErrorMessages {
    ...
    static {
        ...
        errorMessages.put(Integer.valueOf(ERROR_NXT_INVALID_MOTOR_MODE), "%d is an invalid NXT motor mode.");
        errorMessages.put(Integer.valueOf(ERROR_NXT_INVALID_REGULATION_MODE), "%d is an invalid NXT motor regulation mode.");
        errorMessages.put(Integer.valueOf(ERROR_NXT_INVALID_SENSOR_TYPE), "%d is an invalid NXT sensor type.");
        errorMessages.put(Integer.valueOf(ERROR_NXT_INVALID_SENSOR_MODE), "%d is an invalid NXT sensor mode.");
        ...
        errorMessages.put(Integer.valueOf(ERROR_UNCAUGHT_EXCEPTION_IN_THREAD), "Uncaught exception on %s thread: %s");
        ...
        errorMessages.put(1103, "Unable to complete the given request with the text \"%s\" with the specified URL: %s");
        errorMessages.put(1104, "Unable to complete the given request with the file \"%s\" with the specified URL %s.");
        ...
        errorMessages.put(Integer.valueOf(ERROR_WEB_REQUEST_TIMED_OUT), "Took longer then timeout period to receive data from the URL: %s");
        errorMessages.put(Integer.valueOf(ERROR_WEB_JSON_TEXT_ENCODE_FAILED), "Unable to encode as JSON the object %s");
        ...
        errorMessages.put(Integer.valueOf(ERROR_CANNOT_DELETE_FILE), "Cannot delete file at %s");
        errorMessages.put(Integer.valueOf(ERROR_CANNOT_MAKE_DIRECTORY), "Cannot create directory at %s");
        errorMessages.put(Integer.valueOf(ERROR_FILE_EXISTS_AT_PATH), "File already exists at %s");
        errorMessages.put(Integer.valueOf(ERROR_DIRECTORY_DOES_NOT_EXIST), "The directory %s could not be found");
        errorMessages.put(Integer.valueOf(ERROR_NOT_A_DIRECTORY), "The path at %s is not a directory");
        errorMessages.put(Integer.valueOf(ERROR_CANNOT_LIST_DIRECTORY), "Cannot list directory at %s");
        errorMessages.put(Integer.valueOf(ERROR_CANNOT_REMOVE_DIRECTORY), "Cannot remove directory at %s");
        ...
        errorMessages.put(Integer.valueOf(ERROR_INDEX_MISSING_IN_LIST), "Index %d out of bounds in list %s.");
        errorMessages.put(Integer.valueOf(ERROR_NUMBER_FORMAT_EXCEPTION), "Expected a number for an index, but got \"%s\" instead.");
        errorMessages.put(Integer.valueOf(ERROR_INVALID_VALUE_IN_PATH), "Expected a list or dictionary, but found a %s when walking path.");
        ...
        errorMessages.put(Integer.valueOf(ERROR_AUDIO), "Audio Recording Error");
        errorMessages.put(Integer.valueOf(ERROR_CLIENT), "Client Side Error");
        errorMessages.put(Integer.valueOf(ERROR_INSUFFICIENT_PERMISSIONS), "Insufficient Permissions");
        errorMessages.put(Integer.valueOf(ERROR_NETWORK), "Network Error");
        errorMessages.put(Integer.valueOf(ERROR_NETWORK_TIMEOUT), "Network Timeout");
        errorMessages.put(Integer.valueOf(ERROR_NO_MATCH), "No Match");
        ...
        errorMessages.put(Integer.valueOf(ERROR_INVALID_CHART_ENTRY_VALUES), "Invalid Chart Entry Value(s): %1$s, %2$s");
        errorMessages.put(Integer.valueOf(ERROR_NULL_CHART_ENTRY_VALUES), "Undefined value was present in Chart Entry");
        errorMessages.put(Integer.valueOf(ERROR_INSUFFICIENT_CHART_ENTRY_VALUES), "Chart entry did not contain enough values; Expected %1$d, but was %2$d");
        errorMessages.put(Integer.valueOf(ERROR_INVALID_CHART_DATA_COLOR), "Invalid Chart Data color parameter specified: %1$s");
        errorMessages.put(Integer.valueOf(ERROR_CHATBOT_ERROR), "Error from the ChatBot code %1$d %2$s");
        errorMessages.put(Integer.valueOf(ERROR_IMAGEBOT_ERROR), "Error from the ImageBot code %1$d %2$s");
        errorMessages.put(Integer.valueOf(ERROR_SPREADSHEET_ERROR), "Error in Spreadsheet: %1$s");
        errorMessages.put(Integer.valueOf(ERROR_FILEPICKER_NO_URI_RETURNED), "No URI returned to FilePicker");
        errorMessages.put(Integer.valueOf(ERROR_LISTVIEW_INDEX_OUT_OF_BOUNDS), "The index %d is out of bounds for the list view.");
    }
