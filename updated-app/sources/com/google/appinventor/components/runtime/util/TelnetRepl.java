...
public class TelnetRepl extends Procedure0 {
    ...
    public static Thread serve(Language language2, Socket client) throws IOException {
        ...
        BiggerFuture biggerFuture = new BiggerFuture(new TelnetRepl(language2, client), new TtyInPort(sin, (Path) FilePath.valueOf("/dev/stdin"), out), out, out, "Telnet Repl Thread", 262144);
        biggerFuture.start();
        return biggerFuture;
    }
}
