    ...
    public static WebServiceUtil getInstance() {
        synchronized (httpClientSynchronizer) {
            if (httpClient == null) {
                ...
                HttpConnectionParams.setConnectionTimeout(params, AccessibilityNodeInfoCompat.EXTRA_DATA_TEXT_CHARACTER_LOCATION_ARG_MAX_LENGTH);
                HttpConnectionParams.setSoTimeout(params, AccessibilityNodeInfoCompat.EXTRA_DATA_TEXT_CHARACTER_LOCATION_ARG_MAX_LENGTH);
