...
public final class Api extends GeneratedMessageV3 implements ApiOrBuilder {
    ...
    public boolean equals(Object obj) {
        ...
        Api other = (Api) obj;
        boolean result = ((((1 != 0 && getName().equals(other.getName())) && getMethodsList().equals(other.getMethodsList())) && getOptionsList().equals(other.getOptionsList())) && getVersion().equals(other.getVersion())) && hasSourceContext() == other.hasSourceContext();
        if (hasSourceContext()) {
            result = result && getSourceContext().equals(other.getSourceContext());
        }
        if (!(result && getMixinsList().equals(other.getMixinsList())) || this.syntax_ != other.syntax_) {
            return false;
        }
        return true;
    }
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements ApiOrBuilder {
        ...
        public Api buildPartial() {
            Api result = new Api((GeneratedMessageV3.Builder) this);
            ...
            int unused12 = result.bitField0_ = 0;
            onBuilt();
            return result;
        }
