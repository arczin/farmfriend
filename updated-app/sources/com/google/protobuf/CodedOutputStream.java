    ...
    private static class ArrayEncoder extends CodedOutputStream {
        ...
        public final void writeUInt32NoTag(int value) throws IOException {
            if (!CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS || spaceLeft() < 10) {
                ...
                while ((value & -128) != 0) {
                    UnsafeUtil.putByte(this.buffer, pos, (byte) ((value & 127) | 128));
                    this.position++;
                    value >>>= 7;
                    pos = 1 + pos;
                }
                long j = 1 + pos;
                UnsafeUtil.putByte(this.buffer, pos, (byte) value);
                this.position++;
            }
        }
        ...
        public final void writeUInt64NoTag(long value) throws IOException {
            if (!CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS || spaceLeft() < 10) {
                ...
                long pos = CodedOutputStream.ARRAY_BASE_OFFSET + ((long) this.position);
                while ((value & -128) != CodedOutputStream.ARRAY_BASE_OFFSET) {
                    UnsafeUtil.putByte(this.buffer, pos, (byte) ((((int) value) & 127) | 128));
                    this.position++;
                    value >>>= 7;
                    pos++;
                }
                long j = 1 + pos;
                UnsafeUtil.putByte(this.buffer, pos, (byte) ((int) value));
                this.position++;
            }
        }
    ...
    private static abstract class AbstractBufferedEncoder extends CodedOutputStream {
        ...
        public final void bufferUInt64NoTag(long value) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                long pos = originalPos;
                long value2 = value;
                while ((value2 & -128) != CodedOutputStream.ARRAY_BASE_OFFSET) {
                    UnsafeUtil.putByte(this.buffer, pos, (byte) ((((int) value2) & 127) | 128));
                    value2 >>>= 7;
                    pos++;
                }
                UnsafeUtil.putByte(this.buffer, pos, (byte) ((int) value2));
                int delta = (int) ((1 + pos) - originalPos);
                this.position += delta;
                this.totalBytesWritten += delta;
                return;
