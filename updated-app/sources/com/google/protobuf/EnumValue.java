...
public final class EnumValue extends GeneratedMessageV3 implements EnumValueOrBuilder {
    ...
    public boolean equals(Object obj) {
        ...
        if (!((1 != 0 && getName().equals(other.getName())) && getNumber() == other.getNumber()) || !getOptionsList().equals(other.getOptionsList())) {
            return false;
        }
        return true;
    }
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements EnumValueOrBuilder {
        ...
        public EnumValue buildPartial() {
            EnumValue result = new EnumValue((GeneratedMessageV3.Builder) this);
            ...
            int unused5 = result.bitField0_ = 0;
            onBuilt();
            return result;
        }
