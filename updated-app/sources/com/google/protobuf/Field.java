...
public final class Field extends GeneratedMessageV3 implements FieldOrBuilder {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(((((((((1 != 0 && this.kind_ == other.kind_) && this.cardinality_ == other.cardinality_) && getNumber() == other.getNumber()) && getName().equals(other.getName())) && getTypeUrl().equals(other.getTypeUrl())) && getOneofIndex() == other.getOneofIndex()) && getPacked() == other.getPacked()) && getOptionsList().equals(other.getOptionsList())) && getJsonName().equals(other.getJsonName())) || !getDefaultValue().equals(other.getDefaultValue())) {
            return false;
        }
        return true;
    }
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements FieldOrBuilder {
        ...
        public Field buildPartial() {
            Field result = new Field((GeneratedMessageV3.Builder) this);
