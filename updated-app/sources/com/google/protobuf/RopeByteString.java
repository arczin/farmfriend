...
final class RopeByteString extends ByteString {
    ...
    static {
        ...
        numbers.add(Integer.valueOf(ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED));
    ...
    private class RopeInputStream extends InputStream {
        ...
        public int read() throws IOException {
            ...
            return leafByteString.byteAt(i) & Ev3Constants.Opcode.TST;
        }
