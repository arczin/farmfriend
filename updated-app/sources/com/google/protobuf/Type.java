...
public final class Type extends GeneratedMessageV3 implements TypeOrBuilder {
    ...
    public boolean equals(Object obj) {
        ...
        Type other = (Type) obj;
        boolean result = ((((1 != 0 && getName().equals(other.getName())) && getFieldsList().equals(other.getFieldsList())) && getOneofsList().equals(other.getOneofsList())) && getOptionsList().equals(other.getOptionsList())) && hasSourceContext() == other.hasSourceContext();
        if (hasSourceContext()) {
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements TypeOrBuilder {
        ...
        public Type buildPartial() {
            Type result = new Type((GeneratedMessageV3.Builder) this);
            ...
            int unused10 = result.bitField0_ = 0;
            onBuilt();
            return result;
        }
