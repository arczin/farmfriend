...
public final class Value extends GeneratedMessageV3 implements ValueOrBuilder {
    ...
    public boolean equals(Object obj) {
        ...
        boolean result2 = 1 != 0 && getKindCase().equals(other.getKindCase());
        if (!result2) {
            return false;
        }
        switch (this.kindCase_) {
            case 1:
                if (!result2 || getNullValueValue() != other.getNullValueValue()) {
                    result = false;
                }
                return result;
            case 2:
                if (!result2 || Double.doubleToLongBits(getNumberValue()) != Double.doubleToLongBits(other.getNumberValue())) {
                    result = false;
                }
                return result;
            case 3:
                if (!result2 || !getStringValue().equals(other.getStringValue())) {
                    result = false;
                }
                return result;
            case 4:
                if (!result2 || getBoolValue() != other.getBoolValue()) {
                    result = false;
                }
                return result;
            case 5:
                if (!result2 || !getStructValue().equals(other.getStructValue())) {
                    result = false;
                }
                return result;
            case 6:
                if (!result2 || !getListValue().equals(other.getListValue())) {
                    result = false;
                }
                return result;
            default:
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements ValueOrBuilder {
        ...
        public Value buildPartial() {
            Value result = new Value((GeneratedMessageV3.Builder) this);
            if (this.kindCase_ == 1) {
