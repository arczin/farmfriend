...
public class PrimOps extends ModuleBody {
    ...
    static {
        ...
        car = new ModuleMethod(primOps, 1, Lit2, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        cdr = new ModuleMethod(primOps, 2, Lit3, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        setcar = new ModuleMethod(primOps, 3, Lit4, 8194);
        setcdr = new ModuleMethod(primOps, 4, Lit5, 8194);
        boundp = new ModuleMethod(primOps, 5, Lit6, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        symbolp = new ModuleMethod(primOps, 6, Lit7, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        symbol$Mnname = new ModuleMethod(primOps, 7, Lit8, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        symbol$Mnplist = new ModuleMethod(primOps, 8, Lit9, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        ...
        symbol$Mnvalue = new ModuleMethod(primOps, 18, Lit17, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        set = new ModuleMethod(primOps, 19, Lit18, 8194);
        symbol$Mnfunction = new ModuleMethod(primOps, 20, Lit19, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        fset = new ModuleMethod(primOps, 21, Lit20, 8194);
        apply = new ModuleMethod(primOps, 22, Lit21, -4095);
        length = new ModuleMethod(primOps, 23, Lit22, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        arrayp = new ModuleMethod(primOps, 24, Lit23, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        ...
        stringp = new ModuleMethod(primOps, 28, Lit27, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        make$Mnstring = new ModuleMethod(primOps, 29, Lit28, 8194);
        substring = new ModuleMethod(primOps, 30, Lit29, 12290);
        char$Mnto$Mnstring = new ModuleMethod(primOps, 32, Lit30, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        functionp = new ModuleMethod(primOps, 33, Lit31, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        $instance.run();
    }
