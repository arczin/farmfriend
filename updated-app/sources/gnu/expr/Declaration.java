...
public class Declaration implements SourceLocator {
    ...
    public void load(AccessExp access, int flags2, Compilation comp, Target target) {
        ...
        if (!(target2 instanceof IgnoreTarget)) {
            ...
            if (isAlias() && (this.value instanceof ReferenceExp) && (orig = rexp.binding) != null && (((i & 2) == 0 || orig.isIndirectBinding()) && (owner == null || !orig.needsContext()))) {
                orig.load((rexp = (ReferenceExp) this.value), i, compilation, target2);
            } else if (!isFluid() || !(this.context instanceof FluidLetExp)) {
