...
public abstract class Language {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:16:0x002e A[SYNTHETIC] */
    ...
    public static gnu.expr.Language getInstance(java.lang.String r7) {
        ...
        L_0x001d:
            r6 = r3[r4]     // Catch:{ ClassNotFoundException -> 0x002c }
            java.lang.Class r2 = java.lang.Class.forName(r6)     // Catch:{ ClassNotFoundException -> 0x002c }
            r6 = 0
            r6 = r3[r6]
            gnu.expr.Language r6 = getInstance(r6, r2)
            return r6
        L_0x002c:
            r6 = move-exception
        L_0x002e:
    ...
    public Declaration declFromField(ModuleExp mod, Object fvalue, gnu.bytecode.Field fld) {
        ...
        if (endsWith) {
            fdname = fname;
        } else if (!isFinal || !(obj instanceof Named)) {
        ...
        if (isAlias) {
            ...
            dtype = getTypeFor(ftype.getReflectClass());
        }
