...
public class XML extends ModuleBody {
    ...
    static {
        XML xml = $instance;
        parse$Mnxml$Mnfrom$Mnurl = new ModuleMethod(xml, 1, Lit0, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        element$Mnname = new ModuleMethod(xml, 2, Lit1, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        attribute$Mnname = new ModuleMethod(xml, 3, Lit2, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        $instance.run();
    }
