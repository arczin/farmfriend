...
public class enums extends ModuleBody {
    ...
    static Object lambda2(Object form) {
        ...
        try {
            ...
            SimpleSymbol symbolAppend$V = symbolAppend$V(new Object[]{t$Mnname, Lit24});
            ...
            try {
                ...
                Pair makeValues = makeValues(symbolAppend$V, e$Mnnames);
                TemplateScope make = TemplateScope.make();
                Object execute3 = Lit26.execute(allocVars, make);
                try {
                    ...
                    try {
                        ...
                        Object execute5 = Lit28.execute(allocVars, make2);
                        Object datum$To$SyntaxObject = std_syntax.datum$To$SyntaxObject(obj, t$Mnname);
                        SimpleSymbol simpleSymbol = symbolAppend$V;
                        LList lList = e$Mnnames;
                        LList lList2 = opts;
                        PairWithPosition pairWithPosition = makeInit;
                        Pair pair = makeValues;
                        Symbol symbol = t$Mnname;
                        return Quote.append$V(new Object[]{execute5, Quote.consX$V(new Object[]{datum$To$SyntaxObject, Pair.make(Lit29.execute(allocVars, make2), Quote.append$V(new Object[]{Lit30.execute(allocVars, make2), Pair.make(Lit31.execute(allocVars, make2), Quote.append$V(new Object[]{std_syntax.datum$To$SyntaxObject(obj, opts), Quote.consX$V(new Object[]{std_syntax.datum$To$SyntaxObject(obj, makeInit), Quote.consX$V(new Object[]{std_syntax.datum$To$SyntaxObject(obj, makeValues), Pair.make(Pair.make(Lit32.execute(allocVars, make2), Quote.append$V(new Object[]{Lit33.execute(allocVars, make2), Quote.consX$V(new Object[]{std_syntax.datum$To$SyntaxObject(obj, t$Mnname), Quote.append$V(new Object[]{Lit34.execute(allocVars, make2), Pair.make(Lit35.execute(allocVars, make2), Pair.make(Pair.make(Lit36.execute(allocVars, make2), Quote.consX$V(new Object[]{std_syntax.datum$To$SyntaxObject(obj, t$Mnname), Lit37.execute(allocVars, make2)})), Lit38.execute(allocVars, make2)))})})})), Quote.append$V(new Object[]{std_syntax.datum$To$SyntaxObject(obj, field$Mndescs), Quote.append$V(new Object[]{std_syntax.datum$To$SyntaxObject(obj, other$Mndefs), Lit39.execute(allocVars, make2)})}))})})}))}))})});
                    } catch (ClassCastException e) {
