...
public class swing extends ModuleBody {
    ...
    static {
        ...
        make$Mnaction$Mnlistener = new ModuleMethod(swing, 1, Lit13, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        fill = new ModuleMethod(swing, 2, Lit14, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        draw = new ModuleMethod(swing, 3, Lit15, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        with$Mnpaint = new ModuleMethod(swing, 4, Lit16, 8194);
        with$Mncomposite = new ModuleMethod(swing, 5, Lit17, -4096);
        composite$Mnsrc$Mnover = new ModuleMethod(swing, 6, Lit18, 4096);
        composite$Mnsrc = new ModuleMethod(swing, 8, Lit19, 4096);
        rotation = new ModuleMethod(swing, 10, Lit20, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        with$Mntransform = new ModuleMethod(swing, 11, Lit21, 8194);
        menubar = new ModuleMethod(swing, 12, Lit22, -4096);
        menu = new ModuleMethod(swing, 13, Lit23, -4096);
        menuitem = new ModuleMethod(swing, 14, Lit24, -4096);
        polygon = new ModuleMethod(swing, 15, Lit25, -4095);
        scroll = new ModuleMethod(swing, 16, Lit26, -4095);
        $instance.run();
    }
