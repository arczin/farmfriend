...
public class MakeElement extends NodeConstructor {
    ...
    public static void startElement(Consumer out, Object qname, int copyNamespacesMode2, NamespaceBinding namespaceNodes2) {
        XName type;
        if (qname instanceof Symbol) {
            type = new XName((Symbol) qname, namespaceNodes2);
        } else {
            type = new XName(Symbol.make("", qname.toString(), ""), namespaceNodes2);
        }
    ...
    public static void startElement(Consumer out, Object qname, int copyNamespacesMode2) {
        Symbol type;
        if (qname instanceof Symbol) {
            type = (Symbol) qname;
        } else {
