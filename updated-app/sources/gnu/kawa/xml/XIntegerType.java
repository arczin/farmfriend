...
public class XIntegerType extends XDataType {
    ...
    public static final XIntegerType longType = new XIntegerType("long", (XDataType) integerType, 8, IntNum.make(Long.MIN_VALUE), IntNum.make((long) LocationRequestCompat.PASSIVE_INTERVAL));
