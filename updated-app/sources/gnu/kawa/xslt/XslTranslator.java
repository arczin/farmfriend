    ...
    public void endElement() {
        ...
        if (xslTag == "value-of") {
            ...
            if (select != null) {
                ...
                push(new ApplyExp(XQParser.makeText, exp));
            }
            ...
            this.comp.exprStack.pop();
            push((Expression) new ApplyExp((Expression) new QuoteExp(applyTemplatesProc), new QuoteExp(popMatchingAttribute("", "select", start + 1)), resolveQNameExpression(popMatchingAttribute("", "mode", start + 1))));
        } else if (xslTag == "if") {
            ...
            String popMatchingAttribute = popMatchingAttribute("", "version", start + 1);
            ...
            String popMatchingAttribute2 = popMatchingAttribute("", "priority", start + 1);
            ...
            while (true) {
                ...
                if (i >= 0) {
                    ...
                    this.comp.exprStack.pop();
                    Expression exp3 = new ApplyExp(XQParser.makeText, args);
                    push(exp3);
                    this.mexp.body = exp3;
                    return;
                }
            ...
            Expression[] args2 = new Expression[(this.comp.exprStack.size() - start)];
            int i2 = args2.length;
            while (true) {
                i2--;
                if (i2 >= 0) {
                    args2[i2] = this.comp.exprStack.pop();
                } else {
                    Expression exp4 = new ApplyExp((Expression) new QuoteExp(new MakeElement()), args2);
                    push(exp4);
                    this.mexp.body = exp4;
                    return;
                }
