        ...
        if (callContext.where != 0 || i == 0) {
            switch (i) {
                case 0:
                    ...
                    break;
                case 1:
                    obj = procedure.apply1(callContext.getNextArg());
                    break;
                case 2:
                    obj = procedure.apply2(callContext.getNextArg(), callContext.getNextArg());
                    break;
                case 3:
                    obj = procedure.apply3(callContext.getNextArg(), callContext.getNextArg(), callContext.getNextArg());
                    break;
                case 4:
                    obj = procedure.apply4(callContext.getNextArg(), callContext.getNextArg(), callContext.getNextArg(), callContext.getNextArg());
                    break;
                default:
                    obj = procedure.applyN(callContext.getArgs());
                    break;
            }
        } else {
            obj = procedure.applyN(callContext.values);
        }
