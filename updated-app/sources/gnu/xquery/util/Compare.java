...
public class Compare extends Procedure2 {
    ...
    public static boolean apply(int flags2, Object arg1, Object arg2, NamedCollator collator) {
    ...
    public static boolean equalityComparison(int flags2) {
        return ((flags2 & 16) != 0) == ((flags2 & 4) != 0);
    }

    public static boolean atomicCompare(int flags2, Object arg1, Object arg2, NamedCollator collator) {
        int comp;
        int comp2;
        int comp3;
        ...
        if ((arg1 instanceof Number) || (arg2 instanceof Number)) {
            if ((arg1 instanceof Duration) != 0) {
            ...
            } else if ((arg1 instanceof DateTime) != 0) {
                if (!(arg2 instanceof DateTime)) {
                    ...
                    if (m1 != d22.components()) {
                        comp = -3;
                    } else if (equalityComparison(flags2) != 0 || m1 == 112 || m1 == 14 || m1 == 126) {
                        comp = DateTime.compare(d12, d22);
                    } else {
                        comp = -3;
                    }
                }
            } else if ((arg2 instanceof Duration) != 0 || (arg2 instanceof DateTime)) {
                comp = -3;
            } else {
        ...
        } else if ((arg1 instanceof Boolean) != 0) {
        ...
        } else if ((arg2 instanceof Boolean) != 0 || (arg2 instanceof Symbol)) {
            comp2 = -3;
        } else {
