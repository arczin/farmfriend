...
public class characters extends ModuleBody {
    ...
    static {
        ...
        char$Qu = new ModuleMethod(characters, 1, Lit0, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        char$Mn$Grinteger = new ModuleMethod(characters, 2, Lit1, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        integer$Mn$Grchar = new ModuleMethod(characters, 3, Lit2, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
