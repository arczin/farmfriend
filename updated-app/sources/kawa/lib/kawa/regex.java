...
public class regex extends ModuleBody {
    ...
    static {
        ...
        regex$Mnquote = new ModuleMethod(regex, 2, Lit1, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        regex$Mnmatch$Qu = new ModuleMethod(regex, 3, Lit2, InputDeviceCompat.SOURCE_STYLUS);
        regex$Mnmatch = new ModuleMethod(regex, 6, Lit3, InputDeviceCompat.SOURCE_STYLUS);
        regex$Mnmatch$Mnpositions = new ModuleMethod(regex, 9, Lit4, InputDeviceCompat.SOURCE_STYLUS);
