...
public class keywords extends ModuleBody {
    ...
    static {
        ...
        keyword$Qu = new ModuleMethod(keywords, 1, Lit0, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        keyword$Mn$Grstring = new ModuleMethod(keywords, 2, Lit1, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        string$Mn$Grkeyword = new ModuleMethod(keywords, 3, Lit2, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        $instance.run();
    }
