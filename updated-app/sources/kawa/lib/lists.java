...
public class lists extends ModuleBody {
    ...
    static {
        ...
        pair$Qu = new ModuleMethod(lists, 1, Lit3, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        cons = new ModuleMethod(lists, 2, Lit4, 8194);
        null$Qu = new ModuleMethod(lists, 3, Lit5, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        set$Mncar$Ex = new ModuleMethod(lists, 4, Lit6, 8194);
        set$Mncdr$Ex = new ModuleMethod(lists, 5, Lit7, 8194);
        ...
        length = new ModuleMethod(lists, 64, Lit8, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        reverse = new ModuleMethod(lists, 65, Lit9, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        list$Mntail = new ModuleMethod(lists, 66, Lit10, 8194);
        list$Mnref = new ModuleMethod(lists, 67, Lit11, 8194);
        list$Qu = new ModuleMethod(lists, 68, Lit12, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        reverse$Ex = new ModuleMethod(lists, 69, Lit13, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        memq = new ModuleMethod(lists, 70, Lit14, 8194);
        memv = new ModuleMethod(lists, 71, Lit15, 8194);
        member = new ModuleMethod(lists, 72, Lit16, 12290);
        assq = new ModuleMethod(lists, 74, Lit17, 8194);
        assv = new ModuleMethod(lists, 75, Lit18, 8194);
        assoc = new ModuleMethod(lists, 76, Lit19, 12290);
        $instance.run();
    }
    ...
    public static LList reverse(LList list) {
        ...
        while (!isNull(arg)) {
            try {
                Pair pair = (Pair) arg;
                arg = cdr.apply1(pair);
                lList = cons(car.apply1(pair), lList);
