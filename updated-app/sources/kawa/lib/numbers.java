...
public class numbers extends ModuleBody {
    ...
    static {
        ...
        number$Qu = new ModuleMethod(numbers, 1, Lit3, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        quantity$Qu = new ModuleMethod(numbers, 2, Lit4, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        complex$Qu = new ModuleMethod(numbers, 3, Lit5, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        real$Qu = new ModuleMethod(numbers, 4, Lit6, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        rational$Qu = new ModuleMethod(numbers, 5, Lit7, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        integer$Qu = new ModuleMethod(numbers, 6, Lit8, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        exact$Qu = new ModuleMethod(numbers, 7, Lit9, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        inexact$Qu = new ModuleMethod(numbers, 8, Lit10, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        zero$Qu = new ModuleMethod(numbers, 9, Lit11, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        positive$Qu = new ModuleMethod(numbers, 10, Lit12, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        negative$Qu = new ModuleMethod(numbers, 11, Lit13, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        max = new ModuleMethod(numbers, 12, Lit14, -4096);
        min = new ModuleMethod(numbers, 13, Lit15, -4096);
        abs = new ModuleMethod(numbers, 14, Lit16, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        div$Mnand$Mnmod = new ModuleMethod(numbers, 15, Lit17, 8194);
        div0$Mnand$Mnmod0 = new ModuleMethod(numbers, 16, Lit18, 8194);
        gcd = new ModuleMethod(numbers, 17, Lit19, -4096);
        lcm = new ModuleMethod(numbers, 18, Lit20, -4096);
        numerator = new ModuleMethod(numbers, 19, Lit21, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        denominator = new ModuleMethod(numbers, 20, Lit22, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        floor = new ModuleMethod(numbers, 21, Lit23, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        ceiling = new ModuleMethod(numbers, 22, Lit24, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        truncate = new ModuleMethod(numbers, 23, Lit25, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        round = new ModuleMethod(numbers, 24, Lit26, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        rationalize = new ModuleMethod(numbers, 25, Lit27, 8194);
        exp = new ModuleMethod(numbers, 26, Lit28, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        log = new ModuleMethod(numbers, 27, Lit29, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        sin = new ModuleMethod(numbers, 28, Lit30, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        cos = new ModuleMethod(numbers, 29, Lit31, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        ...
        make$Mnpolar = new ModuleMethod(numbers, 38, Lit36, 8194);
        real$Mnpart = new ModuleMethod(numbers, 39, Lit37, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        imag$Mnpart = new ModuleMethod(numbers, 40, Lit38, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        magnitude = new ModuleMethod(numbers, 41, Lit39, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        angle = new ModuleMethod(numbers, 42, Lit40, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        inexact = new ModuleMethod(numbers, 43, Lit41, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        exact = new ModuleMethod(numbers, 44, Lit42, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        exact$Mn$Grinexact = new ModuleMethod(numbers, 45, Lit43, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        inexact$Mn$Grexact = new ModuleMethod(numbers, 46, Lit44, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        logop = new ModuleMethod(numbers, 47, Lit45, 12291);
        bitwise$Mnbit$Mnset$Qu = new ModuleMethod(numbers, 48, Lit46, 8194);
        bitwise$Mncopy$Mnbit = new ModuleMethod(numbers, 49, Lit47, 12291);
        bitwise$Mncopy$Mnbit$Mnfield = new ModuleMethod(numbers, 50, Lit48, 16388);
        bitwise$Mnbit$Mnfield = new ModuleMethod(numbers, 51, Lit49, 12291);
        bitwise$Mnif = new ModuleMethod(numbers, 52, Lit50, 12291);
        logtest = new ModuleMethod(numbers, 53, Lit51, 8194);
        logcount = new ModuleMethod(numbers, 54, Lit52, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        bitwise$Mnbit$Mncount = new ModuleMethod(numbers, 55, Lit53, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        bitwise$Mnlength = new ModuleMethod(numbers, 56, Lit54, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        bitwise$Mnfirst$Mnbit$Mnset = new ModuleMethod(numbers, 57, Lit55, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        bitwise$Mnrotate$Mnbit$Mnfield = new ModuleMethod(numbers, 58, Lit56, 16388);
        bitwise$Mnreverse$Mnbit$Mnfield = new ModuleMethod(numbers, 59, Lit57, 12291);
        number$Mn$Grstring = new ModuleMethod(numbers, 60, Lit58, 8193);
        string$Mn$Grnumber = new ModuleMethod(numbers, 62, Lit59, 8193);
        quantity$Mn$Grnumber = new ModuleMethod(numbers, 64, Lit60, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        quantity$Mn$Grunit = new ModuleMethod(numbers, 65, Lit61, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        make$Mnquantity = new ModuleMethod(numbers, 66, Lit62, 8194);
        duration = new ModuleMethod(numbers, 67, Lit63, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        $instance.run();
    }
    ...
    public static Object divAndMod(RealNum x, RealNum y) {
        ...
        try {
            ...
            try {
                return misc.values(q, LangObjType.coerceRealNum(apply22));
            } catch (ClassCastException e) {
    ...
    public static IntNum bitwiseRotateBitField(IntNum n, int start, int end, int count) {
        ...
        return bitwiseCopyBitField(n, start, end, BitOps.ior(IntNum.shift(field0, count2), IntNum.shift(field0, count2 - width)));
    }
            ...
            case 37:
                try {
                    try {
                        ...
                        throw new WrongType(e9, "make-rectangular", 2, obj4);
                    }
                } catch (ClassCastException e10) {
                    throw new WrongType(e10, "make-rectangular", 1, obj3);
                }
            case 38:
                try {
                    try {
                        ...
                        throw new WrongType(e11, "make-polar", 2, obj4);
                    }
                } catch (ClassCastException e12) {
                    throw new WrongType(e12, "make-polar", 1, obj3);
                }
            case 48:
                try {
                    try {
                        ...
                        throw new WrongType(e13, "bitwise-bit-set?", 2, obj4);
                    }
                } catch (ClassCastException e14) {
                    throw new WrongType(e14, "bitwise-bit-set?", 1, obj3);
                }
            case 53:
                try {
                    try {
                        ...
                        throw new WrongType(e15, "logtest", 2, obj4);
                    }
                } catch (ClassCastException e16) {
                    throw new WrongType(e16, "logtest", 1, obj3);
                }
            case 60:
                try {
                    try {
                        ...
                        throw new WrongType(e17, "number->string", 2, obj4);
                    }
                } catch (ClassCastException e18) {
                    throw new WrongType(e18, "number->string", 1, obj3);
                }
            case 62:
                try {
                    try {
                        ...
                        throw new WrongType(e19, "string->number", 2, obj4);
                    }
                } catch (ClassCastException e20) {
                    throw new WrongType(e20, "string->number", 1, obj3);
                }
            case 66:
