...
public class ports extends ModuleBody {
    ...
    static {
        ...
        open$Mninput$Mnfile = new ModuleMethod(ports, 1, Lit10, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        open$Mnoutput$Mnfile = new ModuleMethod(ports, 2, Lit11, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        call$Mnwith$Mninput$Mnfile = new ModuleMethod(ports, 3, Lit12, 8194);
        call$Mnwith$Mnoutput$Mnfile = new ModuleMethod(ports, 4, Lit13, 8194);
        with$Mninput$Mnfrom$Mnfile = new ModuleMethod(ports, 5, Lit14, 8194);
        ...
        get$Mnoutput$Mnstring = new ModuleMethod(ports, 16, Lit21, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        call$Mnwith$Mninput$Mnstring = new ModuleMethod(ports, 17, Lit22, 8194);
        call$Mnwith$Mnoutput$Mnstring = new ModuleMethod(ports, 18, Lit23, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        force$Mnoutput = new ModuleMethod(ports, 19, Lit24, 4096);
        newline = new ModuleMethod(ports, 21, Lit25, 4096);
        eof$Mnobject$Qu = new ModuleMethod(ports, 23, Lit26, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        char$Mnready$Qu = new ModuleMethod(ports, 24, Lit27, 4096);
        write = new ModuleMethod(ports, 26, Lit28, 8193);
        display = new ModuleMethod(ports, 28, Lit29, 8193);
        input$Mnport$Mnread$Mnstate = new ModuleMethod(ports, 30, Lit30, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        set$Mnport$Mnline$Ex = new ModuleMethod(ports, 31, Lit31, 8194);
        port$Mnline$Fn4 = new ModuleMethod(ports, 32, Lit32, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        set$Mninput$Mnport$Mnline$Mnnumber$Ex = new ModuleMethod(ports, 33, Lit33, 8194);
        input$Mnport$Mnline$Mnnumber$Fn5 = new ModuleMethod(ports, 34, Lit34, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        port$Mncolumn = new ModuleMethod(ports, 35, Lit35, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        input$Mnport$Mncolumn$Mnnumber = new ModuleMethod(ports, 36, Lit36, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        default$Mnprompter = new ModuleMethod(ports, 37, Lit37, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        set$Mninput$Mnport$Mnprompter$Ex = new ModuleMethod(ports, 38, Lit38, 8194);
        input$Mnport$Mnprompter$Fn6 = new ModuleMethod(ports, 39, Lit39, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        close$Mninput$Mnport = new ModuleMethod(ports, 40, Lit40, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        close$Mnoutput$Mnport = new ModuleMethod(ports, 41, Lit41, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        read = new ModuleMethod(ports, 42, Lit42, 4096);
        read$Mnline = new ModuleMethod(ports, 44, Lit43, 8192);
        transcript$Mnon = new ModuleMethod(ports, 47, Lit44, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        transcript$Mnoff = new ModuleMethod(ports, 48, Lit45, 0);
        $instance.run();
    }
    ...
    public final void run(CallContext $ctx) {
        ...
        Procedure input$Mnport$Mnline$Mnnumber2 = input$Mnport$Mnline$Mnnumber$Fn5;
        ...
        input$Mnport$Mnprompter.setProperties(new Object[]{Lit5, set$Mninput$Mnport$Mnprompter$Ex, input$Mnport$Mnprompter$Fn6});
    }
    ...
    public static Object defaultPrompter(Object port) {
        ...
        try {
            return strings.stringAppend(obj, numbers.number$To$String((Number) apply1), "|# ");
        } catch (ClassCastException e) {
