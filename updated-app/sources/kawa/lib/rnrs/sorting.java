...
public class sorting extends ModuleBody {
    ...
    static {
        ...
        list$Mnsort = new ModuleMethod(sorting, 1, Lit0, 8194);
        vector$Mnsort = new ModuleMethod(sorting, 2, Lit1, 8194);
        vector$Mnsort$Ex = new ModuleMethod(sorting, 3, Lit2, 8194);
        $instance.run();
    }
