...
public class unicode extends ModuleBody {
    ...
    static {
        ...
        char$Mnupcase = new ModuleMethod(unicode, 1, Lit0, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        char$Mndowncase = new ModuleMethod(unicode, 2, Lit1, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        char$Mntitlecase = new ModuleMethod(unicode, 3, Lit2, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        char$Mnalphabetic$Qu = new ModuleMethod(unicode, 4, Lit3, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        char$Mnnumeric$Qu = new ModuleMethod(unicode, 5, Lit4, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        char$Mnwhitespace$Qu = new ModuleMethod(unicode, 6, Lit5, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        char$Mnupper$Mncase$Qu = new ModuleMethod(unicode, 7, Lit6, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        char$Mnlower$Mncase$Qu = new ModuleMethod(unicode, 8, Lit7, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        char$Mntitle$Mncase$Qu = new ModuleMethod(unicode, 9, Lit8, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        char$Mnfoldcase = new ModuleMethod(unicode, 10, Lit9, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        char$Mnci$Eq$Qu = new ModuleMethod(unicode, 11, Lit10, 8194);
        char$Mnci$Ls$Qu = new ModuleMethod(unicode, 12, Lit11, 8194);
        char$Mnci$Gr$Qu = new ModuleMethod(unicode, 13, Lit12, 8194);
        char$Mnci$Ls$Eq$Qu = new ModuleMethod(unicode, 14, Lit13, 8194);
        char$Mnci$Gr$Eq$Qu = new ModuleMethod(unicode, 15, Lit14, 8194);
        char$Mngeneral$Mncategory = new ModuleMethod(unicode, 16, Lit15, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        string$Mnupcase = new ModuleMethod(unicode, 17, Lit16, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        string$Mndowncase = new ModuleMethod(unicode, 18, Lit17, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        string$Mntitlecase = new ModuleMethod(unicode, 19, Lit18, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        string$Mnfoldcase = new ModuleMethod(unicode, 20, Lit19, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        string$Mnci$Eq$Qu = new ModuleMethod(unicode, 21, Lit20, 8194);
        string$Mnci$Ls$Qu = new ModuleMethod(unicode, 22, Lit21, 8194);
        string$Mnci$Gr$Qu = new ModuleMethod(unicode, 23, Lit22, 8194);
        string$Mnci$Ls$Eq$Qu = new ModuleMethod(unicode, 24, Lit23, 8194);
        string$Mnci$Gr$Eq$Qu = new ModuleMethod(unicode, 25, Lit24, 8194);
        string$Mnnormalize$Mnnfd = new ModuleMethod(unicode, 26, Lit25, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        string$Mnnormalize$Mnnfkd = new ModuleMethod(unicode, 27, Lit26, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        string$Mnnormalize$Mnnfc = new ModuleMethod(unicode, 28, Lit27, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        string$Mnnormalize$Mnnfkc = new ModuleMethod(unicode, 29, Lit28, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        $instance.run();
    }
