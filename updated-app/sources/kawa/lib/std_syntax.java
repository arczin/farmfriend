...
public class std_syntax extends ModuleBody {
    ...
    public static final Macro f2case = Macro.make(Lit4, Lit5, $instance);
    ...
    public static final Macro f3do = Macro.make(Lit40, Lit41, $instance);
    ...
    static {
        ...
        Lit29 = new SyntaxRules(objArr2, new SyntaxRule[]{new SyntaxRule(syntaxPattern4, "\u0003\u0000", "\u0011\u0018\u0004\u0019\b\u0005\u0003\n", objArr3, 1), new SyntaxRule(syntaxPattern5, "\u0001\u0003\u0000", "©\u0011\u0018\u0004y\b\t\u0003\b\u0011\u0018\f\u0019\b\r\u000b\t\u0010\b\u0012\b\u0003\b\r\u0011\u0018\u0014\b\u000b", new Object[]{Lit71, simpleSymbol14, simpleSymbol15}, 1)}, 3);
    ...
    public static Object generateTemporaries(Object list) {
        ...
        while (Scheme.numEqu.apply2(n, Lit0) == Boolean.FALSE) {
            ...
            lst = new Pair(datum$To$SyntaxObject(list, Symbols.gentemp()), lst);
        }
        return lst;
    }
