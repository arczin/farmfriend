...
public class strings extends ModuleBody {
    ...
    static {
        ...
        string$Qu = new ModuleMethod(strings, 1, Lit1, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        make$Mnstring = new ModuleMethod(strings, 2, Lit2, 8193);
        $make$string$ = new ModuleMethod(strings, 4, Lit3, -4096);
        string$Mnlength = new ModuleMethod(strings, 5, Lit4, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        ...
        string$Mn$Grlist = new ModuleMethod(strings, 14, Lit13, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        list$Mn$Grstring = new ModuleMethod(strings, 15, Lit14, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        string$Mncopy = new ModuleMethod(strings, 16, Lit15, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        string$Mnfill$Ex = new ModuleMethod(strings, 17, Lit16, 8194);
        string$Mnupcase$Ex = new ModuleMethod(strings, 18, Lit17, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        string$Mndowncase$Ex = new ModuleMethod(strings, 19, Lit18, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        string$Mncapitalize$Ex = new ModuleMethod(strings, 20, Lit19, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        string$Mncapitalize = new ModuleMethod(strings, 21, Lit20, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
