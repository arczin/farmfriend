...
public class system extends ModuleBody {
    ...
    static {
        ...
        open$Mninput$Mnpipe = new ModuleMethod(system2, 2, Lit3, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        system = new ModuleMethod(system2, 3, Lit4, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        convert$Mnvector$Mnto$Mnstring$Mnarray = new ModuleMethod(system2, 4, Lit5, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        convert$Mnlist$Mnto$Mnstring$Mnarray = new ModuleMethod(system2, 5, Lit6, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        ...
        f6catch = new ModuleMethod(system2, 9, Lit10, 12291);
    ...
    /* renamed from: catch  reason: not valid java name */
    public static Object m594catch(Object key, Procedure thunk, Procedure handler) {
        try {
            return thunk.apply0();
    ...
    public Object apply3(ModuleMethod moduleMethod, Object obj, Object obj2, Object obj3) {
        ...
        try {
            try {
                return m594catch(obj, (Procedure) obj2, (Procedure) obj3);
            } catch (ClassCastException e) {
