...
public class thread extends ModuleBody {
    ...
    static {
        ...
        sleep = new ModuleMethod(thread, 1, Lit0, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        $Prvt$$Pcmake$Mnfuture = new ModuleMethod(thread, 2, Lit3, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        runnable = new ModuleMethod(thread, 3, Lit4, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        $instance.run();
    }
