...
public class uniform extends ModuleBody {
    ...
    static {
        ...
        s8vector$Qu = new ModuleMethod(uniform, 1, Lit1, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        make$Mns8vector = new ModuleMethod(uniform, 2, Lit2, 8193);
        s8vector = new ModuleMethod(uniform, 4, Lit3, -4096);
        s8vector$Mnlength = new ModuleMethod(uniform, 5, Lit4, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        s8vector$Mnref = new ModuleMethod(uniform, 6, Lit5, 8194);
        s8vector$Mnset$Ex = new ModuleMethod(uniform, 7, Lit6, 12291);
        s8vector$Mn$Grlist = new ModuleMethod(uniform, 8, Lit7, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        list$Mn$Grs8vector = new ModuleMethod(uniform, 9, Lit8, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        u8vector$Qu = new ModuleMethod(uniform, 10, Lit9, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        make$Mnu8vector = new ModuleMethod(uniform, 11, Lit10, 8193);
        u8vector = new ModuleMethod(uniform, 13, Lit11, -4096);
        u8vector$Mnlength = new ModuleMethod(uniform, 14, Lit12, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        u8vector$Mnref = new ModuleMethod(uniform, 15, Lit13, 8194);
        u8vector$Mnset$Ex = new ModuleMethod(uniform, 16, Lit14, 12291);
        u8vector$Mn$Grlist = new ModuleMethod(uniform, 17, Lit15, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        list$Mn$Gru8vector = new ModuleMethod(uniform, 18, Lit16, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        s16vector$Qu = new ModuleMethod(uniform, 19, Lit17, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        make$Mns16vector = new ModuleMethod(uniform, 20, Lit18, 8193);
        s16vector = new ModuleMethod(uniform, 22, Lit19, -4096);
        s16vector$Mnlength = new ModuleMethod(uniform, 23, Lit20, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        s16vector$Mnref = new ModuleMethod(uniform, 24, Lit21, 8194);
        s16vector$Mnset$Ex = new ModuleMethod(uniform, 25, Lit22, 12291);
        s16vector$Mn$Grlist = new ModuleMethod(uniform, 26, Lit23, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        list$Mn$Grs16vector = new ModuleMethod(uniform, 27, Lit24, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        u16vector$Qu = new ModuleMethod(uniform, 28, Lit25, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        make$Mnu16vector = new ModuleMethod(uniform, 29, Lit26, 8193);
        u16vector = new ModuleMethod(uniform, 31, Lit27, -4096);
        u16vector$Mnlength = new ModuleMethod(uniform, 32, Lit28, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        u16vector$Mnref = new ModuleMethod(uniform, 33, Lit29, 8194);
        u16vector$Mnset$Ex = new ModuleMethod(uniform, 34, Lit30, 12291);
        u16vector$Mn$Grlist = new ModuleMethod(uniform, 35, Lit31, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        list$Mn$Gru16vector = new ModuleMethod(uniform, 36, Lit32, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        s32vector$Qu = new ModuleMethod(uniform, 37, Lit33, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        make$Mns32vector = new ModuleMethod(uniform, 38, Lit34, 8193);
        s32vector = new ModuleMethod(uniform, 40, Lit35, -4096);
        s32vector$Mnlength = new ModuleMethod(uniform, 41, Lit36, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        s32vector$Mnref = new ModuleMethod(uniform, 42, Lit37, 8194);
        s32vector$Mnset$Ex = new ModuleMethod(uniform, 43, Lit38, 12291);
        s32vector$Mn$Grlist = new ModuleMethod(uniform, 44, Lit39, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        list$Mn$Grs32vector = new ModuleMethod(uniform, 45, Lit40, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        u32vector$Qu = new ModuleMethod(uniform, 46, Lit41, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        make$Mnu32vector = new ModuleMethod(uniform, 47, Lit42, 8193);
        u32vector = new ModuleMethod(uniform, 49, Lit43, -4096);
        u32vector$Mnlength = new ModuleMethod(uniform, 50, Lit44, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        u32vector$Mnref = new ModuleMethod(uniform, 51, Lit45, 8194);
        u32vector$Mnset$Ex = new ModuleMethod(uniform, 52, Lit46, 12291);
        u32vector$Mn$Grlist = new ModuleMethod(uniform, 53, Lit47, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        list$Mn$Gru32vector = new ModuleMethod(uniform, 54, Lit48, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        s64vector$Qu = new ModuleMethod(uniform, 55, Lit49, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        make$Mns64vector = new ModuleMethod(uniform, 56, Lit50, 8193);
        s64vector = new ModuleMethod(uniform, 58, Lit51, -4096);
        s64vector$Mnlength = new ModuleMethod(uniform, 59, Lit52, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        s64vector$Mnref = new ModuleMethod(uniform, 60, Lit53, 8194);
        s64vector$Mnset$Ex = new ModuleMethod(uniform, 61, Lit54, 12291);
        s64vector$Mn$Grlist = new ModuleMethod(uniform, 62, Lit55, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        list$Mn$Grs64vector = new ModuleMethod(uniform, 63, Lit56, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        u64vector$Qu = new ModuleMethod(uniform, 64, Lit57, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        make$Mnu64vector = new ModuleMethod(uniform, 65, Lit58, 8193);
        u64vector = new ModuleMethod(uniform, 67, Lit59, -4096);
        u64vector$Mnlength = new ModuleMethod(uniform, 68, Lit60, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        u64vector$Mnref = new ModuleMethod(uniform, 69, Lit61, 8194);
        u64vector$Mnset$Ex = new ModuleMethod(uniform, 70, Lit62, 12291);
        u64vector$Mn$Grlist = new ModuleMethod(uniform, 71, Lit63, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        list$Mn$Gru64vector = new ModuleMethod(uniform, 72, Lit64, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        f32vector$Qu = new ModuleMethod(uniform, 73, Lit65, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        make$Mnf32vector = new ModuleMethod(uniform, 74, Lit66, 8193);
        f32vector = new ModuleMethod(uniform, 76, Lit67, -4096);
        f32vector$Mnlength = new ModuleMethod(uniform, 77, Lit68, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        f32vector$Mnref = new ModuleMethod(uniform, 78, Lit69, 8194);
        f32vector$Mnset$Ex = new ModuleMethod(uniform, 79, Lit70, 12291);
        f32vector$Mn$Grlist = new ModuleMethod(uniform, 80, Lit71, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        list$Mn$Grf32vector = new ModuleMethod(uniform, 81, Lit72, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        f64vector$Qu = new ModuleMethod(uniform, 82, Lit73, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        make$Mnf64vector = new ModuleMethod(uniform, 83, Lit74, 8193);
        f64vector = new ModuleMethod(uniform, 85, Lit75, -4096);
        f64vector$Mnlength = new ModuleMethod(uniform, 86, Lit76, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        f64vector$Mnref = new ModuleMethod(uniform, 87, Lit77, 8194);
        f64vector$Mnset$Ex = new ModuleMethod(uniform, 88, Lit78, 12291);
        f64vector$Mn$Grlist = new ModuleMethod(uniform, 89, Lit79, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        list$Mn$Grf64vector = new ModuleMethod(uniform, 90, Lit80, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        $instance.run();
    }
