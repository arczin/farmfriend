...
public class vectors extends ModuleBody {
    ...
    static {
        ...
        vector$Qu = new ModuleMethod(vectors, 1, Lit1, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        make$Mnvector = new ModuleMethod(vectors, 2, Lit2, 8193);
        vector$Mnlength = new ModuleMethod(vectors, 4, Lit3, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        vector$Mnset$Ex = new ModuleMethod(vectors, 5, Lit4, 12291);
        vector$Mnref$Fn1 = new ModuleMethod(vectors, 6, Lit5, 8194);
        vector$Mn$Grlist = new ModuleMethod(vectors, 7, Lit6, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        list$Mn$Grvector = new ModuleMethod(vectors, 8, Lit7, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        vector$Mnfill$Ex = new ModuleMethod(vectors, 9, Lit8, 8194);
        $instance.run();
    }
    ...
    public final void run(CallContext $ctx) {
        ...
        vector$Mnref.setProperties(new Object[]{Lit0, vector$Mnset$Ex, vector$Mnref$Fn1});
    }
